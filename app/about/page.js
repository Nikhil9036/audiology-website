  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <p className="text-lg text-gray-700 leading-relaxed mb-6">
        At Heal Hearing, we are dedicated to empowering individuals to achieve a fulfilling and vibrant life through optimal hearing health.
      ...
      <ul className="list-disc list-inside text-lg text-gray-700 leading-relaxed mb-6">
        ...
        <li><strong>Innovative Solutions:</strong> We leverage cutting-edge technology to address diverse hearing needs.</li>
        <li><strong>Client-Centric Approach:</strong> Your needs and goals are at the forefront of our services.</li>
        <li><strong>Continuous Improvement:</strong> We strive for excellence in everything we do.</li>
      </ul>

      <p className="text-lg text-gray-700 leading-relaxed mb-6 font-semibold">Our Team</p>
      <p className="text-lg text-gray-700 leading-relaxed mb-6">
        Our team members are highly skilled, knowledgeable, and dedicated professionals. With a deep passion for hearing health, they are committed to providing trustworthy guidance and support every step of the way.
      </p>
